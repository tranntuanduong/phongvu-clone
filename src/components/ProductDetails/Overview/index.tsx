...
import { StyledImageConllection, StyledOverview, StyledProductOverview, StyledPromote } from "./ProductOverview"
    ...
    <StyledProductOverview>
      <StyledImageConllection>
        ...
        <ul className="sub-info">
          <li className="sub-info__item">
            - Chip đồ họa: GeForce RTX 3080Ti
          </li>
          <li className="sub-info__item">
            - Bộ nhớ: 12GB GDDR6X (384-bit)
          </li>
          <li className="sub-info__item">
            - Boost: 1695 MHz
          </li>
      ...
      <StyledOverview>
        <h3 className="title">
          Card màn hình MSI GeForce RTX 3080 Ti VENTUS 3X 12G OC 12GB GDDR6X 3080 Ti VENTUS 3X 12G OC 12GB GDDR6X
        </h3>
        <div className="brand-wrap">
          <div className="brand">Thương hiệu: <span>MSI</span></div>
        ...
        <StyledPromote>
          ...
          <ul className="list">
            <li className="item">
              ...
              <a href="help.phongvu-clone.netlify" className="link">Xem chi tiết</a>
            </li>
            <li className="item">
              Nhập mã
              <span className="voucher">PHONGVU300K</span>
